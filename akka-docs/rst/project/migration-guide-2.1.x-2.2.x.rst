...
monitoring interest, but if the target actor terminated already the
:class:`Terminated` message was already enqueued and would be received
...
if :meth:`unwatch` was called before processing the :class:`Terminated`
